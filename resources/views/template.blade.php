...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="{{url('/')}}">Escola </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{url('turma/listar')}}">Turma</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{url('aluno/listar')}}">Aluno</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{url('materia/listar')}}">Materia</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{url('professor/listar')}}">Professor</a>
        </li>
        <li class="nav-item">
